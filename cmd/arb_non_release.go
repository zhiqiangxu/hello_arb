...
import (
	...
	v4wire "github.com/zhiqiangxu/arbbot/pkg/protocol/eth/p2pwire/fsn/v4"
		...
		Lite: litenode.Config{
			Eth: &common2.NodeConfig{
				P2P: p2p.Config{
					...
					TrustedNodes: eth.Nodes{}.Convert(),
					// EnableMsgEvents: true,
					ExtraConfig: devp2p.ExtraConfig{WireManager: &v4wire.Wire{}},
				},
				Handler: common2.HandlerConfig{
					NetworkID:   32659,
					GenesisHash: common.HexToHash("0xc2422b1d9d16331be2a5b207c0783027d4419498003f729f4b9e9c5c1838623a"),
				},
				TxPool:   common2.TxPoolConfig{HashCap: 10000, TxCap: 1000},
				...
				EthProtocolVersions: common2.ProtocolVersions{
					Name:     "efsn",
					Versions: []uint{62, 63},
					Lengths:  map[uint]uint64{62: 8, 63: 17},
				},
			},
		},
		Bot: bot.Config{
...
func init() {
	ArbCmd.Subcommands = append(ArbCmd.Subcommands, arbCPKFileCmd)
}
